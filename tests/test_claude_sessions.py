"""Unit tests for ai_agents_usage_monitor.claude_sessions.
...
from ai_agents_usage_monitor.claude_sessions import (
    WindowStats, _extract_entry, _parse_timestamp, clear_cache, usage_in_window,
)
...
class TestUsageInWindow(unittest.TestCase):
    ...
    def test_old_file_skipped_by_mtime_without_parsing(self):
        ...
        with patch('ai_agents_usage_monitor.claude_sessions._parse_file') as mock_parse:
            stats = usage_in_window(self.root, _epoch(2026, 8, 13, 9, 0, 0), _epoch(2026, 8, 13, 11, 0, 0))
